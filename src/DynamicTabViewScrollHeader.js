...
class DynamicTabViewScrollHeader extends React.Component {
	...
	_renderTitle = ({ item, index }) => {
		...
		return (
			<TouchableHighlight
				onPress={this._onPressHeader.bind(null, index)}
				style={[
					DynamicdefaultStyle.tabItemContainer,
					{ backgroundColor: this.props.headerBackgroundColor },
					this.props.tabItemContainerStyle,
					isTabActive ? this.props.activeTabStyle : null,
				]}
				...
				<View>
					<Text
						style={[
							...
							DynamicdefaultStyle.tabItemText,
							isTabActive
